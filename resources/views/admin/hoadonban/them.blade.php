								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
												<input type="text" style="width:50%" class="form-control" name="tensp">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
												<input type="text" style="width:50%" class="form-control" name="id_loai">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="tenhang">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-3 control-label">Độ cao:</label>
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="docao">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-3 control-label">Giá:</label>
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="gia">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-3 control-label">Giá khuyến mại:</label>
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="giakm">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-3 control-label">Số lượng:</label>
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="soluong">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-3 control-label">New:</label>
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="new">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-3 control-label">Tình trạng:</label>
											<div class="col-lg-9">
													<input type="text" style="width:50%" class="form-control" class="styled" name="tinhtrang">
											</div>
										</div>
